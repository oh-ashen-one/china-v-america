...
A cinematic dual-rail film in browser chrome. Two civilizations of compute, one spine.

This is not a SaaS landing page. Desktop 1440-1920 is the film hero: a persistent dual-rail frame with a glowing vs-spine down the center. Cursor X-position crossfades which world is lit.

America rail: black, cold white, NASA blue, legal-pad amber, server-room fluorescence, grotesque type, hairline rules, tabular numerals.

China rail: lacquer black, cinnabar, jade, warm gold, night-city cyan, Song-dynasty geometry colliding with Shenzhen LED.
